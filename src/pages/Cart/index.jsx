...
const Cart = () => {
  return (
    <div className={s.content}>
      <div className={cn(s.container, s.containerCart)}>
        <div className={s.cart}>
          ...
          <div className={s.content__items}>
            <div className={s.cart__item}>
              ...
              <div className={s.cart__itemRemove}>
                <div className={cn(s.button, s.buttonOutline, s.buttonCircle)}>
                  <svg
                    width='10'
                    height='10'
                    viewBox='0 0 10 10'
          ...
          <div className={s.cart__bottom}>
            <div className={s.cart__bottomDetails}>
              <span>
                {' '}
                Всего пицц: <b>3 шт.</b>{' '}
              </span>
            ...
            <div className={s.cart__bottomButtons}>
              <a
                href='/'
                className={cn(
                  s.button,
              ...
              <div className={cn(s.button, s.payBtn)}>
